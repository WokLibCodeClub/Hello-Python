...
We chose ```s``` as the variable name for our screen, but you can use *any* Python variable name which follows the [rules](../step1/step1.md#variable-names).
...
- Back to [previous step](../step2/step2.md).
