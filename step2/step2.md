...
Have your "first ever Python code" (from step 1) open in a browser window. You will also find it useful to have the [Interactive Python Console](https://trinket.strivemath.org/console) open in another tab of your browser.
